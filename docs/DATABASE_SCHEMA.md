# PortGenie Database Schema

This document outlines the database schema for the PortGenie platform, including all necessary tables for user profiles, portfolios, resumes, certifications, and IPFS storage integration via Pinata.
...
-- No need for updated_at trigger since images are immutable
```
